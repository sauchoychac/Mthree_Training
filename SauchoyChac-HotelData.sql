...
('Syed Fawad',	'That One Street 123',	'Dallas',	'TX',	'75012', '123 456 789'),	
...
INSERT INTO Room (RoomNum, RoomType, Amenity1, Amenity2, Amenity3, ADAAccessible, StandardOccupancy, MaxOccupancy, BasePrice, ExtraPerson) VALUES 
(201, 'Double', 'Microwave', 'Jacuzzi', NULL,				'0',  	2, 4, '199.99', '10.00'),
(202, 'Double', 'Refrigerator', NULL, NULL,						'1',  2, 4, '174.99', '10.00'),
(203, 'Double',	'Microwave', 'Jacuzzi', NULL,				'0',  	2, 4, '199.99', '10.00'),
(204, 'Double', 'Refrigerator', NULL, NULL,					'1',  2, 4, '174.99', '10.00'),
(205, 'Single', 'Microwave', 'Refrigerator', 'Jacuzzi',	'0',  	2, 2, '174.99', NULL),
(206, 'Single', 'Microwave', 'Refrigerator', NULL,		 	'1', 	2, 2, '149.99', NULL),
(207, 'Single', 'Microwave', 'Refrigerator', 'Jacuzzi', '0',  	2, 2, '174.99', NULL),
(208, 'Single', 'Microwave', 'Refrigerator', NULL,			'1',  2, 2, '149.99', NULL),
(301, 'Double',	'Microwave', 'Jacuzzi', NULL,				'0', 	2, 4, '199.99', '10.00'),
(302, 'Double',	'Refrigerator',	NULL, NULL,					'1', 	2, 4, '174.99', '10.00'),
(303, 'Double',	'Microwave', 'Jacuzzi', NULL,				'0', 	2, 4, '199.99', '10.00'),
(304, 'Double',	'Refrigerator',	NULL, NULL,					'1', 	2, 4, '174.99', '10.00'),
(305, 'Single',	'Microwave', 'Refrigerator', 'Jacuzzi', '0', 	2, 2, '174.99', NULL),
(306, 'Single',	'Microwave', 'Refrigerator', NULL,			'1', 	2, 2, '149.99', NULL),
(307, 'Single',	'Microwave', 'Refrigerator', 'Jacuzzi', '0', 	2, 2, '174.99', NULL),
(308, 'Single',	'Microwave', 'Refrigerator', NULL,			'1', 	2, 2, '149.99', NULL),
(401, 'Suite', 'Microwave', 'Refrigerator', 'Oven', 	'1', 	3, 8, '399.99', '20.00'),
(402, 'Suite', 'Microwave', 'Refrigerator', 'Oven',		'1', 	3, 8, '399.99', '20.00');


INSERT INTO Reservation (RoomNum, GuestID, Adults, Children, StartDate, EndDate, TotalCost) VALUES
(308,2,1,0,'2023-02-02','2023-04-02','299.98'),
(203,3,2,1,'2023-02-05','2023-02-10','999.95'),
(305,4,2,0,'2023-02-23','2023-02-24','349.98'),
...
(401,4,4,2,'2023-11-22','2023-11-25','1199.97'),
